...
const BannerCard: React.FC<BannerCardProps> = ({
  ...
  return (
    <div
      ...
      style={{
        background: bgColor?.startsWith("bg-") ? undefined : bgColor,
        ...
        >
          ...
          <Image
            ...
            style={{
              width: "5.5rem",
              height: "5.5rem",
              animation: "bannerImageZoom 2.5s infinite",
              maxWidth: "100%",
            }}
          />
        </div>
        <h2 className="text-xl sm:text-2xl font-extrabold text-gray-900 mb-2 text-center w-full">
          {title}
        </h2>
        {description && (
          <p className="text-gray-700 mb-4 text-center w-full">{description}</p>
        )}
        <div className="w-full flex justify-center">
          {(() => {
            ...
            if (buttonColor) {
              ...
              const hexMatch = buttonColor.match(
