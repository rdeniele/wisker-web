  ...
  return (
    <footer className="bg-neutral-700 text-white pt-8 font-sans text-base w-full">
        ...
        <div className="max-w-xs flex flex-col items-start">
          <div className="flex items-center gap-2">
            <Image
              ...
              priority
            />
            <span className="font-extrabold text-3xl text-white leading-tight">
              Wisker
            </span>
          </div>
      ...
      <div className="text-center py-4 text-gray-200 text-sm">
        © 2025 Wisker. All rights reserved. Made with{" "}
        <span className="text-pink-400 text-lg">♥</span> for students
        everywhere.
      </div>
    </footer>
  );
