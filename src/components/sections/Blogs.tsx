...
const blogPosts = [
  {
    ...
    description:
      "Discover the features and benefits of using Wisker for your business.",
  ...
  },
  {
    ...
    description:
      "A quick guide to help you get started with Wisker in minutes.",
...
const Blogs = () => {
  return (
    <section className="py-12 bg-[#f5faff]" id="blogs">
      <h2 className="text-3xl font-extrabold text-center mb-10 text-[#4a90e2] tracking-tight">
        Latest Blogs
      </h2>
          ...
          >
            <div className="relative w-full h-[180px] rounded-t-3xl overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 w-full bg-black/50 px-4 py-2">
                <h3 className="font-bold text-lg text-white text-center m-0">
                  {post.title}
                </h3>
              </div>
            </div>
            <div className="flex flex-col items-center px-8 py-6 w-full">
              <p className="text-gray-700 text-base text-center mb-4 w-full">
                {post.description}
              </p>
              <a
                href={post.url}
