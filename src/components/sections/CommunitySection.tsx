  ...
  <>
    ...
    <div className="w-full flex flex-col items-center justify-center py-8 sm:py-12 gap-6">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-center text-[#676561] mb-2">
        Join <span className="text-orange-300 font-extrabold">1,200+</span> cool
        cats leveling up their grades
      </h2>
      <p className="text-gray-700 text-center text-base sm:text-lg max-w-2xl mb-4">
        Become part of our pawsome community! Stay in the loop, vibe with fellow
        study cats, and connect with Wisker on your fave socials. Let&apos;s get
        that A, no cap!
      </p>
