		...
		<div className="flex min-h-screen bg-[#fafafa] font-fredoka">
			...
			<div className="flex-1 flex flex-col">
				...
				<div className="px-4 py-8">
					...
					<button className="fixed bottom-8 right-8 bg-orange-400 hover:bg-orange-500 text-white font-bold py-3 px-8 rounded-2xl shadow-lg flex items-center gap-2 text-lg z-50 transition active:scale-95">
