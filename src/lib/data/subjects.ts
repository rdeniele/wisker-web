  ...
  1: [
    {
      ...
      lastOpened: new Date(Date.now() - 20000),
      characterCount: 1245,
    },
    {
      id: 2,
      ...
      lastOpened: new Date(Date.now() - 7200000),
      characterCount: 892,
    },
  ],
  2: [
    {
      ...
      lastOpened: new Date(Date.now() - 300000),
      characterCount: 2156,
    },
    {
      id: 2,
      ...
      lastOpened: new Date(Date.now() - 3600000),
      characterCount: 1678,
    },
    {
      id: 3,
      title: "TypeScript Basics",
      createdAt: new Date("2024-12-08T13:45:00"),
    ...
    },
    {
      ...
      createdAt: new Date("2024-12-10T15:20:00"),
    ...
    },
    {
      ...
      lastOpened: new Date(Date.now() - 604800000),
      characterCount: 2543,
    },
  ],
  3: [
    {
      id: 1,
      title: "Physics Laws",
      createdAt: new Date("2024-12-03T08:15:00"),
      lastOpened: new Date(Date.now() - 120000),
      characterCount: 1834,
    },
    {
      id: 2,
    ...
    },
    {
      ...
      lastOpened: new Date(Date.now() - 259200000),
      characterCount: 2109,
    },
  ],
  4: [
    {
      ...
      lastOpened: new Date(Date.now() - 45000),
      characterCount: 1567,
    },
    {
      id: 2,
      title: "Calculus Intro",
      createdAt: new Date("2024-11-30T10:30:00"),
      lastOpened: new Date(Date.now() - 600000),
      characterCount: 2890,
    },
    {
      id: 3,
    ...
    },
    {
      id: 4,
      title: "Trigonometry",
      createdAt: new Date("2024-12-04T13:20:00"),
      lastOpened: new Date(Date.now() - 43200000),
      characterCount: 2345,
    },
    {
      id: 5,
      title: "Statistics",
      createdAt: new Date("2024-12-06T14:45:00"),
      lastOpened: new Date(Date.now() - 129600000),
      characterCount: 3124,
    },
    {
      id: 6,
      title: "Linear Algebra",
      createdAt: new Date("2024-12-08T09:30:00"),
      lastOpened: new Date(Date.now() - 432000000),
      characterCount: 2678,
    },
    {
      id: 7,
      ...
      lastOpened: new Date(Date.now() - 1209600000),
      characterCount: 3456,
    },
    {
      id: 8,
      ...
      lastOpened: new Date(Date.now() - 2592000000),
      characterCount: 1789,
    },
    {
      id: 9,
      title: "Set Theory",
      createdAt: new Date("2024-12-11T13:00:00"),
      lastOpened: new Date(Date.now() - 180000),
      characterCount: 2012,
    },
    {
      id: 10,
      ...
      lastOpened: new Date(Date.now() - 900000),
      characterCount: 2234,
    },
    {
      id: 11,
      title: "Graph Theory",
      createdAt: new Date("2024-12-13T15:15:00"),
      lastOpened: new Date(Date.now() - 10800000),
      characterCount: 1645,
    },
    {
      id: 12,
      ...
      lastOpened: new Date(Date.now() - 54000000),
      characterCount: 1901,
    },
    {
      id: 13,
      ...
      lastOpened: new Date(Date.now() - 216000000),
      characterCount: 2567,
    },
    {
      id: 14,
      ...
      lastOpened: new Date(Date.now() - 518400000),
      characterCount: 2890,
    },
  ],
};
